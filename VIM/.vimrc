...
" To match top status, you'll have to have bright red be the same # as red
...
" File sidebar, C-w -> h/j/k/l to navigate
nnoremap <TAB> <C-w>w
" v to open in a new vertical split, then Shift+<RET> to resize
let g:netrw_banner = 0
let g:netrw_liststyle = 3
let g:netrw_browse_split = 4
let g:netrw_altv = 1
" File view is 15% of whole view (20char on my term)
let g:netrw_winsize = 15
augroup ProjectDrawer
  autocmd!
  autocmd VimEnter * :Vexplore
augroup END
" Shift-enter resizes current pane to be 85 columns (for files)
nnoremap <silent> <C-M> :vertical resize 85<CR>
" Ctrl-P      resizes current pane to be 20 columns (for explorer sidebar)
nnoremap <silent> <C-P> :vertical resize 20<CR>
...
" Treat .notes as pimped help files
au BufRead,BufNewFile *.notes set filetype=help
au BufWinLeave * mkview
au BufWinEnter * silent loadview
au BufRead,BufNewFile *.notes set textwidth=80
